...
Partial Class FinInd
    ...
    Private Sub InitializeComponent()
        ...
        Controls.Add(lblInventoryResult2)
        Controls.Add(Label141)
        Controls.Add(lblTotOperatingRevResult5)
        Controls.Add(lblOtherExpenseResultFindInd)
        Controls.Add(lblDepreciationExpenseResultFinInd3)
        Controls.Add(Label137)
        Controls.Add(lblTotOperatingRevResult4)
        Controls.Add(lblTotOperatingExpenseFinInd5)
        Controls.Add(lblTotCurrentLiabilitesResult3)
