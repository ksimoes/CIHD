...
Partial Class Profile
    ...
    Private Sub InitializeComponent()
        ...
        gbGpo = New GroupBox()
        gbBillingNpis = New GroupBox()
        gbAssociatedNpis = New GroupBox()
        gbComponents = New GroupBox()
        gbBodGm = New GroupBox()
        ...
        gbAco = New GroupBox()
        gbEhr = New GroupBox()
        gbUtalizationStatsbyPayor = New GroupBox()
        gbHmoUtil = New GroupBox()
        gbJointCommissionAccredit = New GroupBox()
        gbEstimatePatientVolumes = New GroupBox()
        gbClinicalServices = New GroupBox()
        gbVerifiedTrauma = New GroupBox()
        gbUniversityAff = New GroupBox()
        gbTeaching = New GroupBox()
        ...
        lbladdy.Location = New Point(144, 44)
        ...
        lblSpecialCareBedsResult.Location = New Point(172, 519)
        ...
        lblGeneralMedSurgBedsResult.Location = New Point(175, 484)
        ...
        lblPhoneNumResult.Location = New Point(144, 74)
        ...
        lblNameAddressResult.Location = New Point(144, 20)
        ...
        lblSpecialCareBeds.Location = New Point(5, 519)
        ...
        lblGeneralMedSurgBeds.Location = New Point(6, 476)
        ...
        llHospitalWeb.Location = New Point(144, 98)
        ...
        lblHospitalWeb.Location = New Point(6, 98)
        ...
        lblPhoneNum.Location = New Point(3, 74)
        ...
        lblPurchasingMat.Location = New Point(6, 174)
        ...
        lblCoo.Location = New Point(6, 150)
        lblCoo.Name = "lblCoo"
        ...
        lblCno.Location = New Point(6, 123)
        lblCno.Name = "lblCno"
        ...
        lblCmo.Location = New Point(6, 98)
        lblCmo.Name = "lblCmo"
        ...
        lblCio.Location = New Point(6, 74)
        lblCio.Name = "lblCio"
        ...
        lblCfo.Location = New Point(6, 44)
        lblCfo.Name = "lblCfo"
        ...
        lblCeoPres.Location = New Point(6, 19)
        ...
        gbGpo.TabIndex = 3
        gbGpo.TabStop = False
        gbGpo.Text = "Group Purchasing Organizations (GPO's)"
        ' 
        ' gbBillingNpis
        ' 
        ...
        gbBillingNpis.TabIndex = 3
        gbBillingNpis.TabStop = False
        gbBillingNpis.Text = "Billing NPI's"
        ' 
        ' gbAssociatedNpis
        ' 
        ...
        gbAssociatedNpis.TabIndex = 3
        gbAssociatedNpis.TabStop = False
        gbAssociatedNpis.Text = "Associated NPI's"
        ' 
        ' gbComponents
        ' 
        ...
        gbComponents.TabIndex = 3
        gbComponents.TabStop = False
        gbComponents.Text = "Components (Medicare Certified)"
        ' 
        ' gbBodGm
        ' 
        ...
        gbBodGm.TabIndex = 3
        gbBodGm.TabStop = False
        gbBodGm.Text = "Board of Directors/Governance Members"
        ' 
        ' DataGridView3
        ' 
        DataGridView3.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize
        DataGridView3.Columns.AddRange(New DataGridViewColumn() {Column4, Column5, Column6})
        DataGridView3.Location = New Point(2, 18)
        DataGridView3.Name = "DataGridView3"
        DataGridView3.Size = New Size(333, 94)
        ...
        gbAco.TabIndex = 4
        gbAco.TabStop = False
        gbAco.Text = "Accountable Care Organizations(ACO's)"
        ' 
        ' gbEhr
        ' 
        ...
        gbEhr.TabIndex = 4
        gbEhr.TabStop = False
        gbEhr.Text = "Electronic Health Record System (EHR)"
        ' 
        ...
        gbUtalizationStatsbyPayor.TabIndex = 4
        gbUtalizationStatsbyPayor.TabStop = False
        gbUtalizationStatsbyPayor.Text = "Utalization Statistics by Payor"
        ' 
        ' gbHmoUtil
        ' 
        ...
        gbHmoUtil.TabIndex = 4
        gbHmoUtil.TabStop = False
        gbHmoUtil.Text = "HMO Utilization"
        ' 
        ...
        gbJointCommissionAccredit.TabIndex = 5
        gbJointCommissionAccredit.TabStop = False
        gbJointCommissionAccredit.Text = "Joint Commission Accreditation"
        ' 
        ...
        gbEstimatePatientVolumes.TabIndex = 5
        gbEstimatePatientVolumes.TabStop = False
        gbEstimatePatientVolumes.Text = "Estimated Patient Volumes"
        ' 
        ' gbClinicalServices
        ' 
        ...
        gbClinicalServices.TabIndex = 5
        gbClinicalServices.TabStop = False
        gbClinicalServices.Text = "Clinical Services"
        ' 
        ' gbVerifiedTrauma
        ' 
        ...
        gbVerifiedTrauma.TabIndex = 6
        gbVerifiedTrauma.TabStop = False
        gbVerifiedTrauma.Text = "Verified Trauma Program"
        ' 
        ' gbUniversityAff
        ' 
        ...
        gbUniversityAff.TabIndex = 7
        gbUniversityAff.TabStop = False
        gbUniversityAff.Text = "University Aflliliation"
        ' 
        ' gbTeaching
        ' 
        ...
        gbTeaching.TabIndex = 8
        gbTeaching.TabStop = False
        gbTeaching.Text = "Teaching Status"
        ' 
        ' btnOutpatientProfile
        ' 
        btnOutpatientProfile.BackColor = Color.GhostWhite
        btnOutpatientProfile.Location = New Point(1491, 11)
        ...
        btnInpatientProfile.Location = New Point(1421, 12)
        ...
        btnQualityProfile.Location = New Point(1365, 12)
        ...
        btnFinIndProfile.Location = New Point(1302, 12)
        ...
        btnFinancialProfile.Location = New Point(1243, 12)
        ...
        btnDepartmentProfile.Location = New Point(1158, 12)
        ...
        Controls.Add(btnFinIndProfile)
        Controls.Add(btnFinancialProfile)
        Controls.Add(btnDepartmentProfile)
        Controls.Add(gbTeaching)
        Controls.Add(gbUniversityAff)
        Controls.Add(gbVerifiedTrauma)
        Controls.Add(gbEstimatePatientVolumes)
        Controls.Add(gbClinicalServices)
        Controls.Add(gbJointCommissionAccredit)
        Controls.Add(gbEhr)
        Controls.Add(gbUtalizationStatsbyPayor)
        Controls.Add(gbHmoUtil)
        Controls.Add(gbAco)
        Controls.Add(gbGpo)
        Controls.Add(gbBillingNpis)
        Controls.Add(gbAssociatedNpis)
        Controls.Add(gbComponents)
        Controls.Add(gbBodGm)
        Controls.Add(gbTax)
        ...
        gbTax.ResumeLayout(False)
        CType(DataGridView2, ComponentModel.ISupportInitialize).EndInit()
        gbBodGm.ResumeLayout(False)
    ...
    Friend WithEvents gbTax As GroupBox
    Friend WithEvents gbGpo As GroupBox
    Friend WithEvents gbBillingNpis As GroupBox
    Friend WithEvents gbAssociatedNpis As GroupBox
    Friend WithEvents gbComponents As GroupBox
    Friend WithEvents gbBodGm As GroupBox
    Friend WithEvents gbAco As GroupBox
    Friend WithEvents gbEhr As GroupBox
    Friend WithEvents gbUtalizationStatsbyPayor As GroupBox
    Friend WithEvents gbHmoUtil As GroupBox
    Friend WithEvents gbJointCommissionAccredit As GroupBox
    Friend WithEvents gbEstimatePatientVolumes As GroupBox
    Friend WithEvents gbClinicalServices As GroupBox
    Friend WithEvents gbVerifiedTrauma As GroupBox
    Friend WithEvents gbUniversityAff As GroupBox
    Friend WithEvents gbTeaching As GroupBox
