        ...
        Using client As New HttpClient()
            ...
            If response.IsSuccessStatusCode Then
                ...
                If data.Count > 0 Then
                    ...
                    lblTotOperatingExpenseResult.Text = Search.CleanMeUp(provider("Less Total Operating Expense"))
                    lblContractAllowanceResult.Text = Search.CleanMeUp(provider("Less Contractual Allowance and Discounts on Patients' Account"))
                    lblTotOtherIncomeResult.Text = Search.CleanMeUp(provider("Total Other Income"))
                    lblTotOtherExpensesResult.Text = Search.CleanMeUp(provider("Total Other Expenses"))
                    ...
                    lblCurLiabilitiesRes.Text = Search.CleanMeUp(provider("Total Current Liabilities"))
                    lblLtResult.Text = Search.CleanMeUp(provider("Total Long Term Liabilities"))
                    lblTlResult.Text = Search.CleanMeUp(provider("Total Liabilities"))
                    lblTotFbResult.Text = Search.CleanMeUp(provider("Total Fund Balances"))
                    lblTotLandFbResult.Text = Search.CleanMeUp(provider("Total Liabilities and Fund Balances"))
